...
Configuration:
# - Model: Flaubert_base
# - tokenizer : Flaubert_base
# - Source data: europenan train 3, dev, test
...
class FlaubertForTokenClassification(PreTrainedModel):
    ...
    def __init__(self, bert, config):
        ...
        self.domain_classifier = nn.Sequential(
            nn.Linear(2*config.emb_dim, config.emb_dim),
...
#
        ...
        # domain Classifier: taking last 2 hidden layers
...
checkpoint_dir = './flaubert_non-da/inference/'
