...
checkpoint_dir = './camembert_non-da-e/'
model_dir = './camembert_non-da-e/best_model/'
inference_dir = './camembert_non-da-e/inference/'
...
for epoch in range(start_epoch, num_epochs+1):
    ...
    if results["overall_f1"] > max_f1_score:
        max_f1_score = results["overall_f1"]
