...
import transformers 
from transformers import get_scheduler, DataCollatorForTokenClassification
from transformers import AutoConfig, CamembertModel, CamembertConfig, PreTrainedModel, AutoTokenizer
...
source_features = datasets.Features(
    {
        ...
        "ner_tags": datasets.Sequence(
            datasets.features.ClassLabel(
                ...
                # names = ['O','B-LOC', 'I-PER', 'B-PER', 'I-ORG', 'I-MISC', 'B-ORG','I-LOC', 'B-MISC']
...
checkpoint_dir = './Camembert-da/inference/'
model_dir = '/Camembert-da/best_model/'
inference_dir = './Camembert-da/inference/'
